...
- Follow the R code conventions in `scripts/AGENTS.md`.
- Save all scripts to the appropriate `scripts/[task_group]/` directory.
- Save all outputs to `results/` under the appropriate subdirectory.
...
Save all diagnostic figures to `results/img/`.

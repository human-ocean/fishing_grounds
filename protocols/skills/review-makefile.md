...
2. **For each Makefile, follow the review protocol below:**
   - Read the Makefile section of `scripts/AGENTS.md`.
...
example, `scripts/estimation/bootstrap/Makefile` maps to
`quality_reports/scripts_estimation_bootstrap_makefile_review.md`.
